...
from .views import Home, CoursesIndex, CourseDetail, LessonsIndex, LessonDetail, CoverCourseDetail, CreateUserView, LoginView, VerifyUserView, ReviewsIndex, ReviewDetail
...
urlpatterns = [
  ...
  path('lessons/<int:id>/', LessonDetail.as_view(), name='lesson_detail'),
